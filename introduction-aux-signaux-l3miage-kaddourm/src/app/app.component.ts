import { ChangeDetectionStrategy, Component, NgZone, Signal, WritableSignal, computed, effect, signal } from '@angular/core';
...
export class AppComponent {
  ...
  question01() {
    ...
    const b = computed<string[]>(() => Array.from({length: a()}, (_, i) => String(Math.floor(Math.random() * 101))));
